defmodule WaitingRoomWeb.Router do
  use WaitingRoomWeb, :router

  import WaitingRoomWeb.UserAuth

  import WaitingRoomWeb.AdminAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {WaitingRoomWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: WaitingRoomWeb.Telemetry
    end
  end
