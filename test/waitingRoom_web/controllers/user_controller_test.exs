defmodule WaitingRoomWeb.UserControllerTest do
  use WaitingRoomWeb.ConnCase

  import WaitingRoom.PatientFixtures

  @create_attrs %{created_by: 42, first_name: "some first_name", health_num: 42, id: 42, last_name: "some last_name", phone: 42}
